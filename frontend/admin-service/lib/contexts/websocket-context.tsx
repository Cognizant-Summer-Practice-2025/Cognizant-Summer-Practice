...
export const WebSocketProvider: React.FC<WebSocketProviderProps> = ({ children }) => {
  ...
  const connect = useCallback(async () => {
    ...
    try {
      ...
      console.warn('SignalR connection failed (this is optional for admin service):', error instanceof Error ? error.message : error);
      // SignalR connection failure is not critical for the admin service
