...
IMAGE_TAG="${1:-latest}"
APP_NAME="home-portfolio-service"
DOCKERFILE="$REPO_ROOT/frontend/home-portfolio-service/Dockerfile"
CONTEXT_DIR="$REPO_ROOT/frontend/home-portfolio-service"
...
echo "  NEXT_PUBLIC_AUTH_USER_SERVICE: $NEXT_PUBLIC_AUTH_USER_SERVICE"
echo "  NEXT_PUBLIC_HOME_PORTFOLIO_SERVICE: $NEXT_PUBLIC_HOME_PORTFOLIO_SERVICE"
echo "  NEXT_PUBLIC_MESSAGES_SERVICE: $NEXT_PUBLIC_MESSAGES_SERVICE"
echo "  NEXT_PUBLIC_ADMIN_SERVICE: $NEXT_PUBLIC_ADMIN_SERVICE"
echo "  NEXT_PUBLIC_USER_API_URL: $NEXT_PUBLIC_USER_API_URL"
echo "  NEXT_PUBLIC_PORTFOLIO_API_URL: $NEXT_PUBLIC_PORTFOLIO_API_URL"
echo "  NEXT_PUBLIC_MESSAGES_API_URL: $NEXT_PUBLIC_MESSAGES_API_URL"
