...
IMAGE_TAG="${1:-latest}"
APP_NAME="auth-user-service"
DOCKERFILE="$REPO_ROOT/frontend/auth-user-service/Dockerfile"
CONTEXT_DIR="$REPO_ROOT/frontend/auth-user-service"
...
NEXT_PUBLIC_AI_API_URL="${NEXT_PUBLIC_AI_API_URL:-http://localhost:5134}"
