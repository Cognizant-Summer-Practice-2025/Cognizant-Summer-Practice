...
namespace backend_portfolio.Services
{
    public class PortfolioQueryService : IPortfolioQueryService
    {
        ...
        public async Task<IEnumerable<PortfolioDetailResponse>> GetAllPortfoliosDetailedAsync()
        {
            ...
            {
                var portfolios = await _portfolioRepository.GetAllPortfoliosAsync();
                // Map to detail without template enrichment (template kept as null)
                var detailed = portfolios.Select(p => new PortfolioDetailResponse
                {
                    Id = p.Id,
                    UserId = p.UserId,
                    ...
                    Template = null,
                    Projects = p.Projects.Select(pr => new ProjectSummaryResponse
                    {
                        Id = pr.Id,
                        Title = pr.Title,
                    ...
                    Experience = p.Experience.Select(e => new ExperienceSummaryResponse
                    {
                        Id = e.Id,
                        JobTitle = e.JobTitle,
                    ...
                    Skills = p.Skills.Select(s => new SkillSummaryResponse
                    {
                        Id = s.Id,
                        Name = s.Name,
                    ...
                    BlogPosts = p.BlogPosts.Select(b => new BlogPostSummaryResponse
                    {
                        Id = b.Id,
                        Title = b.Title,
                        Excerpt = b.Excerpt,
            ...
            {
                _logger.LogError(ex, "Error occurred while getting all portfolios detailed");
                throw;
            }
        }
