...
namespace backend_AI.tests.Config
{
    public class CorsConfigurationTests
    {
        ...
        public void AddCorsConfiguration_WithConfiguredUrls_ShouldUseConfigured()
        {
            ...
            options.GetPolicy(CorsConfiguration.FrontendPolicyName)!.Origins.Should().BeEquivalentTo(new[]{"http://example.com","http://another.com"});
        }
        ...
        public void AddCorsConfiguration_WithoutConfiguredUrls_ShouldFallbackToDefaults()
        {
            ...
            options.GetPolicy(CorsConfiguration.FrontendPolicyName)!.Origins.Should().Contain(new[]{
                "http://localhost:3000",
                "http://localhost:3001",
                "http://localhost:3002",
                "http://localhost:3003"
